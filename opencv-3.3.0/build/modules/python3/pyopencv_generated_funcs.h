...
static PyObject* pyopencv_cv_freetype_createFreeType2(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ERRWRAP2(retval = cv::freetype::createFreeType2());
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_linemod_linemod_Detector_Detector(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::linemod;

    {
    pyopencv_linemod_Detector_t* self = 0;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        self = PyObject_NEW(pyopencv_linemod_Detector_t, &pyopencv_linemod_Detector_Type);
...
static PyObject* pyopencv_cv_linemod_linemod_Feature_Feature(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::linemod;

    {
    pyopencv_linemod_Feature_t* self = 0;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        self = PyObject_NEW(pyopencv_linemod_Feature_t, &pyopencv_linemod_Feature_Type);
...
static PyObject* pyopencv_cv_linemod_linemod_Match_Match(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::linemod;

    {
    pyopencv_linemod_Match_t* self = 0;

    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        self = PyObject_NEW(pyopencv_linemod_Match_t, &pyopencv_linemod_Match_Type);
...
static PyObject* pyopencv_cv_sfm_KRtFromProjection(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OOO:KRtFromProjection", (char**)keywords, &pyobj_P, &pyobj_K, &pyobj_R, &pyobj_t) &&
        pyopencv_to(pyobj_P, P, ArgInfo("P", 0)) &&
        pyopencv_to(pyobj_K, K, ArgInfo("K", 1)) &&
        pyopencv_to(pyobj_R, R, ArgInfo("R", 1)) &&
        pyopencv_to(pyobj_t, t, ArgInfo("t", 1)) )
...
static PyObject* pyopencv_cv_sfm_applyTransformationToPoints(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|O:applyTransformationToPoints", (char**)keywords, &pyobj_points, &pyobj_T, &pyobj_transformed_points) &&
        pyopencv_to(pyobj_points, points, ArgInfo("points", 0)) &&
        pyopencv_to(pyobj_T, T, ArgInfo("T", 0)) &&
        pyopencv_to(pyobj_transformed_points, transformed_points, ArgInfo("transformed_points", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_computeOrientation(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOd|OO:computeOrientation", (char**)keywords, &pyobj_x1, &pyobj_x2, &s, &pyobj_R, &pyobj_t) &&
        pyopencv_to(pyobj_x1, x1, ArgInfo("x1", 0)) &&
        pyopencv_to(pyobj_x2, x2, ArgInfo("x2", 0)) &&
        pyopencv_to(pyobj_R, R, ArgInfo("R", 1)) &&
        pyopencv_to(pyobj_t, t, ArgInfo("t", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_depth(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO:depth", (char**)keywords, &pyobj_R, &pyobj_t, &pyobj_X) &&
        pyopencv_to(pyobj_R, R, ArgInfo("R", 0)) &&
        pyopencv_to(pyobj_t, t, ArgInfo("t", 0)) &&
        pyopencv_to(pyobj_X, X, ArgInfo("X", 0)) )
    {
...
static PyObject* pyopencv_cv_sfm_essentialFromFundamental(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|O:essentialFromFundamental", (char**)keywords, &pyobj_F, &pyobj_K1, &pyobj_K2, &pyobj_E) &&
        pyopencv_to(pyobj_F, F, ArgInfo("F", 0)) &&
        pyopencv_to(pyobj_K1, K1, ArgInfo("K1", 0)) &&
        pyopencv_to(pyobj_K2, K2, ArgInfo("K2", 0)) &&
        pyopencv_to(pyobj_E, E, ArgInfo("E", 1)) )
...
static PyObject* pyopencv_cv_sfm_essentialFromRt(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|O:essentialFromRt", (char**)keywords, &pyobj_R1, &pyobj_t1, &pyobj_R2, &pyobj_t2, &pyobj_E) &&
        pyopencv_to(pyobj_R1, R1, ArgInfo("R1", 0)) &&
        pyopencv_to(pyobj_t1, t1, ArgInfo("t1", 0)) &&
        pyopencv_to(pyobj_R2, R2, ArgInfo("R2", 0)) &&
        pyopencv_to(pyobj_t2, t2, ArgInfo("t2", 0)) &&
        pyopencv_to(pyobj_E, E, ArgInfo("E", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_euclideanToHomogeneous(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    const char* keywords[] = { "src", "dst", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:euclideanToHomogeneous", (char**)keywords, &pyobj_src, &pyobj_dst) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_fundamentalFromCorrespondences7PointRobust(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOd|OOd:fundamentalFromCorrespondences7PointRobust", (char**)keywords, &pyobj_x1, &pyobj_x2, &max_error, &pyobj_F, &pyobj_inliers, &outliers_probability) &&
        pyopencv_to(pyobj_x1, x1, ArgInfo("x1", 0)) &&
        pyopencv_to(pyobj_x2, x2, ArgInfo("x2", 0)) &&
        pyopencv_to(pyobj_F, F, ArgInfo("F", 1)) &&
        pyopencv_to(pyobj_inliers, inliers, ArgInfo("inliers", 1)) )
...
static PyObject* pyopencv_cv_sfm_fundamentalFromCorrespondences8PointRobust(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    const char* keywords[] = { "x1", "x2", "max_error", "F", "inliers", "outliers_probability", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOd|OOd:fundamentalFromCorrespondences8PointRobust", (char**)keywords, &pyobj_x1, &pyobj_x2, &max_error, &pyobj_F, &pyobj_inliers, &outliers_probability) &&
        pyopencv_to(pyobj_x1, x1, ArgInfo("x1", 0)) &&
        pyopencv_to(pyobj_x2, x2, ArgInfo("x2", 0)) &&
        pyopencv_to(pyobj_F, F, ArgInfo("F", 1)) &&
        pyopencv_to(pyobj_inliers, inliers, ArgInfo("inliers", 1)) )
...
static PyObject* pyopencv_cv_sfm_fundamentalFromEssential(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|O:fundamentalFromEssential", (char**)keywords, &pyobj_E, &pyobj_K1, &pyobj_K2, &pyobj_F) &&
        pyopencv_to(pyobj_E, E, ArgInfo("E", 0)) &&
        pyopencv_to(pyobj_K1, K1, ArgInfo("K1", 0)) &&
        pyopencv_to(pyobj_K2, K2, ArgInfo("K2", 0)) &&
        pyopencv_to(pyobj_F, F, ArgInfo("F", 1)) )
...
static PyObject* pyopencv_cv_sfm_fundamentalFromProjections(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|O:fundamentalFromProjections", (char**)keywords, &pyobj_P1, &pyobj_P2, &pyobj_F) &&
...
static PyObject* pyopencv_cv_sfm_homogeneousToEuclidean(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    const char* keywords[] = { "src", "dst", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:homogeneousToEuclidean", (char**)keywords, &pyobj_src, &pyobj_dst) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_importReconstruction(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OOOOi:importReconstruction", (char**)keywords, &pyobj_file, &pyobj_Rs, &pyobj_Ts, &pyobj_Ks, &pyobj_points3d, &file_format) &&
        pyopencv_to(pyobj_file, file, ArgInfo("file", 0)) &&
        pyopencv_to(pyobj_Rs, Rs, ArgInfo("Rs", 1)) &&
        pyopencv_to(pyobj_Ts, Ts, ArgInfo("Ts", 1)) &&
        pyopencv_to(pyobj_Ks, Ks, ArgInfo("Ks", 1)) &&
        pyopencv_to(pyobj_points3d, points3d, ArgInfo("points3d", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_isotropicPreconditionerFromPoints(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:isotropicPreconditionerFromPoints", (char**)keywords, &pyobj_points, &pyobj_T) &&
        pyopencv_to(pyobj_points, points, ArgInfo("points", 0)) &&
        pyopencv_to(pyobj_T, T, ArgInfo("T", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_sfm_libmv_CameraIntrinsicsOptions_libmv_CameraIntrinsicsOptions(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;

    int _distortion_model=0;
    double _focal_length=0;
    double _principal_point_x=0;
    double _principal_point_y=0;
    double _polynomial_k1=0;
    double _polynomial_k2=0;
    double _polynomial_k3=0;
    double _polynomial_p1=0;
    double _polynomial_p2=0;
    pyopencv_sfm_libmv_CameraIntrinsicsOptions_t* self = 0;

    const char* keywords[] = { "_distortion_model", "_focal_length", "_principal_point_x", "_principal_point_y", "_polynomial_k1", "_polynomial_k2", "_polynomial_k3", "_polynomial_p1", "_polynomial_p2", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|idddddddd:libmv_CameraIntrinsicsOptions", (char**)keywords, &_distortion_model, &_focal_length, &_principal_point_x, &_principal_point_y, &_polynomial_k1, &_polynomial_k2, &_polynomial_k3, &_polynomial_p1, &_polynomial_p2) )
    {
        self = PyObject_NEW(pyopencv_sfm_libmv_CameraIntrinsicsOptions_t, &pyopencv_sfm_libmv_CameraIntrinsicsOptions_Type);
        if(self) ERRWRAP2(new (&(self->v)) cv::sfm::libmv_CameraIntrinsicsOptions(_distortion_model, _focal_length, _principal_point_x, _principal_point_y, _polynomial_k1, _polynomial_k2, _polynomial_k3, _polynomial_p1, _polynomial_p2));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_sfm_sfm_libmv_ReconstructionOptions_libmv_ReconstructionOptions(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;

    int _keyframe1=1;
    int _keyframe2=2;
    int _refine_intrinsics=1;
    int _select_keyframes=1;
    int _verbosity_level=-1;
    pyopencv_sfm_libmv_ReconstructionOptions_t* self = 0;

    const char* keywords[] = { "_keyframe1", "_keyframe2", "_refine_intrinsics", "_select_keyframes", "_verbosity_level", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|iiiii:libmv_ReconstructionOptions", (char**)keywords, &_keyframe1, &_keyframe2, &_refine_intrinsics, &_select_keyframes, &_verbosity_level) )
    {
        self = PyObject_NEW(pyopencv_sfm_libmv_ReconstructionOptions_t, &pyopencv_sfm_libmv_ReconstructionOptions_Type);
        if(self) ERRWRAP2(new (&(self->v)) cv::sfm::libmv_ReconstructionOptions(_keyframe1, _keyframe2, _refine_intrinsics, _select_keyframes, _verbosity_level));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_cv_sfm_meanAndVarianceAlongRows(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:meanAndVarianceAlongRows", (char**)keywords, &pyobj_A, &pyobj_mean, &pyobj_variance) &&
        pyopencv_to(pyobj_A, A, ArgInfo("A", 0)) &&
        pyopencv_to(pyobj_mean, mean, ArgInfo("mean", 1)) &&
        pyopencv_to(pyobj_variance, variance, ArgInfo("variance", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_motionFromEssential(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:motionFromEssential", (char**)keywords, &pyobj_E, &pyobj_Rs, &pyobj_ts) &&
        pyopencv_to(pyobj_E, E, ArgInfo("E", 0)) &&
        pyopencv_to(pyobj_Rs, Rs, ArgInfo("Rs", 1)) &&
        pyopencv_to(pyobj_ts, ts, ArgInfo("ts", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_motionFromEssentialChooseSolution(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOO:motionFromEssentialChooseSolution", (char**)keywords, &pyobj_Rs, &pyobj_ts, &pyobj_K1, &pyobj_x1, &pyobj_K2, &pyobj_x2) &&
        pyopencv_to(pyobj_Rs, Rs, ArgInfo("Rs", 0)) &&
        pyopencv_to(pyobj_ts, ts, ArgInfo("ts", 0)) &&
        pyopencv_to(pyobj_K1, K1, ArgInfo("K1", 0)) &&
        pyopencv_to(pyobj_x1, x1, ArgInfo("x1", 0)) &&
        pyopencv_to(pyobj_K2, K2, ArgInfo("K2", 0)) &&
        pyopencv_to(pyobj_x2, x2, ArgInfo("x2", 0)) )
...
static PyObject* pyopencv_cv_sfm_normalizeFundamental(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:normalizeFundamental", (char**)keywords, &pyobj_F, &pyobj_F_normalized) &&
        pyopencv_to(pyobj_F, F, ArgInfo("F", 0)) &&
        pyopencv_to(pyobj_F_normalized, F_normalized, ArgInfo("F_normalized", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_normalizeIsotropicPoints(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:normalizeIsotropicPoints", (char**)keywords, &pyobj_points, &pyobj_normalized_points, &pyobj_T) &&
        pyopencv_to(pyobj_points, points, ArgInfo("points", 0)) &&
        pyopencv_to(pyobj_normalized_points, normalized_points, ArgInfo("normalized_points", 1)) &&
        pyopencv_to(pyobj_T, T, ArgInfo("T", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_normalizePoints(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    const char* keywords[] = { "points", "normalized_points", "T", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:normalizePoints", (char**)keywords, &pyobj_points, &pyobj_normalized_points, &pyobj_T) &&
        pyopencv_to(pyobj_points, points, ArgInfo("points", 0)) &&
        pyopencv_to(pyobj_normalized_points, normalized_points, ArgInfo("normalized_points", 1)) &&
        pyopencv_to(pyobj_T, T, ArgInfo("T", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_normalizedEightPointSolver(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|O:normalizedEightPointSolver", (char**)keywords, &pyobj_x1, &pyobj_x2, &pyobj_F) &&
        pyopencv_to(pyobj_x1, x1, ArgInfo("x1", 0)) &&
        pyopencv_to(pyobj_x2, x2, ArgInfo("x2", 0)) &&
        pyopencv_to(pyobj_F, F, ArgInfo("F", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_preconditionerFromPoints(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    const char* keywords[] = { "points", "T", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:preconditionerFromPoints", (char**)keywords, &pyobj_points, &pyobj_T) &&
        pyopencv_to(pyobj_points, points, ArgInfo("points", 0)) &&
        pyopencv_to(pyobj_T, T, ArgInfo("T", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_projectionFromKRt(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|O:projectionFromKRt", (char**)keywords, &pyobj_K, &pyobj_R, &pyobj_t, &pyobj_P) &&
        pyopencv_to(pyobj_K, K, ArgInfo("K", 0)) &&
        pyopencv_to(pyobj_R, R, ArgInfo("R", 0)) &&
        pyopencv_to(pyobj_t, t, ArgInfo("t", 0)) &&
        pyopencv_to(pyobj_P, P, ArgInfo("P", 1)) )
...
static PyObject* pyopencv_cv_sfm_projectionsFromFundamental(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:projectionsFromFundamental", (char**)keywords, &pyobj_F, &pyobj_P1, &pyobj_P2) &&
        pyopencv_to(pyobj_F, F, ArgInfo("F", 0)) &&
        pyopencv_to(pyobj_P1, P1, ArgInfo("P1", 1)) &&
        pyopencv_to(pyobj_P2, P2, ArgInfo("P2", 1)) )
    {
...
static PyObject* pyopencv_cv_sfm_relativeCameraMotion(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|OO:relativeCameraMotion", (char**)keywords, &pyobj_R1, &pyobj_t1, &pyobj_R2, &pyobj_t2, &pyobj_R, &pyobj_t) &&
        pyopencv_to(pyobj_R1, R1, ArgInfo("R1", 0)) &&
        pyopencv_to(pyobj_t1, t1, ArgInfo("t1", 0)) &&
        pyopencv_to(pyobj_R2, R2, ArgInfo("R2", 0)) &&
        pyopencv_to(pyobj_t2, t2, ArgInfo("t2", 0)) &&
...
static PyObject* pyopencv_cv_sfm_skew(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:skew", (char**)keywords, &pyobj_x) &&
        pyopencv_to(pyobj_x, x, ArgInfo("x", 0)) )
    {
...
static PyObject* pyopencv_cv_sfm_triangulatePoints(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::sfm;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|O:triangulatePoints", (char**)keywords, &pyobj_points2d, &pyobj_projection_matrices, &pyobj_points3d) &&
        pyopencv_to(pyobj_points2d, points2d, ArgInfo("points2d", 0)) &&
        pyopencv_to(pyobj_projection_matrices, projection_matrices, ArgInfo("projection_matrices", 0)) &&
        pyopencv_to(pyobj_points3d, points3d, ArgInfo("points3d", 1)) )
    {
...
static PyObject* pyopencv_cv_text_OCRBeamSearchDecoder_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|ii:OCRBeamSearchDecoder_create", (char**)keywords, &pyobj_filename, &pyobj_vocabulary, &pyobj_transition_probabilities_table, &pyobj_emission_probabilities_table, &mode, &beam_size) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) &&
        pyopencv_to(pyobj_vocabulary, vocabulary, ArgInfo("vocabulary", 0)) &&
        pyopencv_to(pyobj_transition_probabilities_table, transition_probabilities_table, ArgInfo("transition_probabilities_table", 0)) &&
        pyopencv_to(pyobj_emission_probabilities_table, emission_probabilities_table, ArgInfo("emission_probabilities_table", 0)) )
...
static PyObject* pyopencv_cv_text_OCRHMMDecoder_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|ii:OCRHMMDecoder_create", (char**)keywords, &pyobj_filename, &pyobj_vocabulary, &pyobj_transition_probabilities_table, &pyobj_emission_probabilities_table, &mode, &classifier) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) &&
        pyopencv_to(pyobj_vocabulary, vocabulary, ArgInfo("vocabulary", 0)) &&
        pyopencv_to(pyobj_transition_probabilities_table, transition_probabilities_table, ArgInfo("transition_probabilities_table", 0)) &&
        pyopencv_to(pyobj_emission_probabilities_table, emission_probabilities_table, ArgInfo("emission_probabilities_table", 0)) )
...
static PyObject* pyopencv_cv_text_createERFilterNM1(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|ifffbf:createERFilterNM1", (char**)keywords, &pyobj_filename, &thresholdDelta, &minArea, &maxArea, &minProbability, &nonMaxSuppression, &minProbabilityDiff) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) )
    {
...
static PyObject* pyopencv_cv_text_createERFilterNM2(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|f:createERFilterNM2", (char**)keywords, &pyobj_filename, &minProbability) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) )
    {
...
static PyObject* pyopencv_cv_text_loadOCRHMMClassifier(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::text;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "Oi:loadOCRHMMClassifier", (char**)keywords, &pyobj_filename, &classifier) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) )
    {
